...
#ifndef ASTRON_LIBWASM_DATAGRAM_HXX
#define ASTRON_LIBWASM_DATAGRAM_HXX
...
class Datagram; // forward declaration
...
// A Datagram is a buffer of binary data ready for networking (i.e. formatted according to Astron's
...
class Datagram
{
  protected:
    ...
    */
    ...
    //     capacity is not preserved and instead is reduced to the size of the source datagram.
    ...
    // shallow-constructor:
    //     creates a new datagram that uses an existing buffer for its data
  ...
  public:
    ...
    // a length tag (typically uint16_t) is prepended to the string before it is added.
...
#endif //ASTRON_LIBWASM_DATAGRAM_HXX